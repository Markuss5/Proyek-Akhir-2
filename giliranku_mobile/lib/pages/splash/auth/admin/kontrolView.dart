...
class KontrolItem {
  ...
  factory KontrolItem.fromApiJson(Map<String, dynamic> json) {
    ...
    return KontrolItem(
      ...
      nik: json['nik'] ?? '',
      nama: json['nik'] ?? '', // Will be replaced with patient name if available
      poliklinik: poli,
      dokter: dokter,
      tanggal: date,
...
class AdminKontrolTab extends StatefulWidget {
  const AdminKontrolTab({super.key});

  @override
  State<AdminKontrolTab> createState() => _AdminKontrolTabState();
}

class _AdminKontrolTabState extends State<AdminKontrolTab> {
  ...
  Future<void> _loadData() async {
    ...
    try {
      ...
      print('Error loading kontrol data: $e');
    }
  }
  ...
  int get _terjadwalCount => _kontrolList.where((e) => e.status == 'terjadwal').length;
  int get _selesaiCount => _kontrolList.where((e) => e.status == 'selesai').length;
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          const Text("Tambah Jadwal Kontrol",
                      ...
                      // NIK
                      _dialogTextField(nikCtrl, "NIK Pasien (16 digit)",
                            ...
                            : DropdownButtonHideUnderline(
                                child: DropdownButton<Map<String, dynamic>>(
                                  ...
                                  onChanged: selectedPoli == null
                                      ? null
                                      : (val) {
                                          setDialogState(() => selectedDokter = val);
                                        },
                                ),
                              ),
                      ),
                          ...
                          final picked = await showDatePicker(
                            ...
                            builder: (c, child) => Theme(
                              data: Theme.of(c).copyWith(
                                colorScheme:
                                    const ColorScheme.light(primary: Color(0xFF2F9E8F)),
                              ),
                              child: child!,
                            ),
                          );
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            const Text("Notifikasi Kontrol",
                                                style: TextStyle(
                                                    fontSize: 18,
                                                    fontWeight: FontWeight.bold)),
                                            const SizedBox(height: 2),
                                            Text("Jadwal kontrol rutin pasien",
                                                style: TextStyle(
                                                    fontSize: 12,
      ...
      child: Row(
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              color: isSelesai ? const Color(0xFFE8F5E9) : const Color(0xFFFFF8E1),
              borderRadius: BorderRadius.circular(10),
            ),
            child: Icon(
              isSelesai ? Icons.check_circle : Icons.notifications_active,
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 2),
                if (item.poliklinik.isNotEmpty || item.dokter.isNotEmpty)
                  Text(
