                    ...
                    children: [
                      ...
                      Row(
                        children: [
                          ...
                          _buildStatCard("5", "Dokter Aktif", const Color(0xFFE3F2FD)),
                          const SizedBox(width: 10),
                          _buildStatCard("5", "Jumlah Poliklinik", const Color(0xFFFFF3E0)),
                        ],
                      ),
                    ],
                  ),
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      child: const Icon(Icons.access_time, color: Color(0xFF2F9E8F)),
                    ),
